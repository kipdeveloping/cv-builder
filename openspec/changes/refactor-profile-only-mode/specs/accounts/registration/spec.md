...
- **THEN** el sistema crea la cuenta, el UserProfile, y guarda `title` y `sector_name` en el perfil
...
### Requirement: Registro crea SectorTag via resumes app
**Reason**: SectorTag moved to accounts app; registration now stores sector as free text
**Migration**: Registration wizard saves sector_name directly to UserProfile